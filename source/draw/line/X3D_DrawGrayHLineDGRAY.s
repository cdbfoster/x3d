...
.globl X3D_DrawGrayHLineDGRAY
X3D_DrawGrayHLineDGRAY:
...
2:
	...
	or.w	%d1,(%a1)	|Draw the combined mask
	not.w	%d1
	and.w	%d1,(%a0)
	move.l	(%sp)+,%d3	|Restore d3
	rts
3:	
	or.w	%d0,(%a1)+	|Draw the starting mask
	not.w	%d0
	and.w	%d0,(%a0)+
...
5:
	...
	clr.w	(%a0)+
6:
	or.w	%d1,(%a1)	|Draw the ending mask
	not.w	%d1
	and.w	%d1,(%a0)
	move.l	(%sp)+,%d3	|Restore d3
	rts
