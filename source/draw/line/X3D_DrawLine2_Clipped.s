...
| void X3D_DrawLine2_Clipped(void *Plane asm("%a0"), short x1 asm("%d2"), short y1 asm("%d3"), short x2 asm("%d0"), short y2 asm("%d1"), unsigned char Color);
...
.global X3D_DrawLine2_Clipped
X3D_DrawLine2_Clipped:
	movem.l	%d3 - %d7 / %a2, -(%sp)
